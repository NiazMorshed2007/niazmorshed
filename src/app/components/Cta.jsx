...
const Cta = () => {
    ...
    return (
        <section className='py-20 flex items-center justify-center px-[5%]'>
            <div className='bg-primary/5 w-10/12 p-10 py-16 flex flex-col items-center gap-4 rounded-3xl'>
                ...
                <button onClick={handleOpenEmail} className='p-3 px-6 text-sm mt-5 rounded-md border border-primary/50'>Message Now!</button>
            </div>
        </section>
    )
}
