        ...
        <section id='experience' className='md:py-20 py-6 md:pt-28 pt-20 px-[5%]'>
            ...
            <div className="flex flex-wrap items-center py-2 md:py-16 mt-12 md:mt-28 justify-center gap-8 md:gap-32">
                ...
                <div className="right w-full md:w-1/2">
                    <h1 className='md:text-2xl text-xl font-semibold'>{experiences[activeExperience].role}</h1>
                    <p className='font-semibold text-sm md:text-base text-slate-400'>{experiences[activeExperience].type}</p>
                    <p className='text-slate-400 md:text-base text-sm font-light mt-3'>{experiences[activeExperience].description}</p>
                </div>
            </div>
        </section>
    )
