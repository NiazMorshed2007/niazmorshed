...
export const metadata = {
  title: "Niaz Morshed",
  description:
    "Niaz is a frontend developer who has expertise in React, Next, JavaScript and TypeScript. An open source contributor and loves to build things.",
};
    ...
    <html lang="en">
      ...
      <body className={inter.className}>
        ...
        <div className="fixed z-40 hidden md:flex flex-col items-center gap-7 bottom-12 text-lg text-primary/50 right-16">
          ...
          <Link href={"https://niazmorshed.hashnode.dev/"} target="_blank">
            <SiHashnode />
          </Link>
